...
<?php get_header(); ?>
            ...
            <div class="inner">
                ...
                <div class="menu_area">
                    ...
                    <?php if(have_rows('【CAMPAIGN】料金プラン')): ?>
                        ...
                        <div class="item">
                            <div class="bg">
                                <div class="bg_inner" data-mh="heightLine-menu1">
                ...
                <div class="btn_area">
                    <a href="http://beauty.hotpepper.jp/kr/slnH000156450/coupon/" class="btn yellow row2" target="_blank" onClick="ga('send', 'event', 'hotpeppar_ikebukuro', 'click', 'menu')"><small>池袋店</small>hotpepperクーポンを見る</a>
                    <a href="http://beauty.hotpepper.jp/kr/slnH000330187/coupon" class="btn yellow row2" target="_blank" onClick="ga('send', 'event', 'hotpeppar_kawagoe', 'click', 'menu')"><small>川越店</small>hotpepperクーポンを見る</a>
                </div>
            ...
            <div class="inner">
                ...
                <div class="menu_area">
                    ...
                    <?php if(have_rows('【BRIDAL】料金プラン')): ?>
                        ...
                        <div class="item">
                            <div class="bg">
                                <div class="bg_inner" data-mh="heightLine-menu2">
                                    <h2><?php the_sub_field('タイトル'); ?></h2>
                                    <p class="text text_read"><?php the_sub_field('コース内容'); ?></p>
                                </div>
                                <p class="price"><?php the_sub_field('料金'); ?></p>
        ...
        <section class="standard section">
            <div class="inner">
                <p class="text text_read large">glitterはいつでも<br class="sp">ジェルオフ無料</p>
            </div>
            <div class="tab">
